...
###############################################################################
        ...
        res_message = TextSendMessage(text='歡迎您!               這裡是HOBBY模型店的全天候客服小助手，我隨時在線為您提供幫助。需要查詢商品資訊、了解促銷活動，請點選小方塊獲取最新資訊，若有任何其他購買或是商品上的疑問？
        請隨時發問，我在這裡為您解答！如果您需要與真人客服聯繫，請輸入或點選[人工客服]，系統將在真人客服在線期間為您轉接。感謝您選擇HOBBY模型店，讓我們為您提供最佳的購物體驗！')        
        line_bot_api.reply_message(event.reply_token,res_message)
        return 0   
